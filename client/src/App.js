...
const FONT_OPTIONS = [
    ...
    { label: 'Sans-serif', value: 'sans-serif', fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, system-ui, sans-serif" },
    { label: 'Josefin Sans', value: 'Josefin Sans', fontFamily: "'Josefin Sans', sans-serif", google: true },
    { label: 'Roboto', value: 'Roboto', fontFamily: "'Roboto', sans-serif", google: true },
    { label: 'Open Sans', value: 'Open Sans', fontFamily: "'Open Sans', sans-serif", google: true },
    { label: 'Rubik', value: 'Rubik', fontFamily: "'Rubik', sans-serif", google: true },
    { label: 'DM Sans', value: 'DM Sans', fontFamily: "'DM Sans', sans-serif", google: true },
    { label: 'Poppins', value: 'Poppins', fontFamily: "'Poppins', sans-serif", google: true },
    { label: 'Lato', value: 'Lato', fontFamily: "'Lato', sans-serif", google: true },
    { label: 'Nunito', value: 'Nunito', fontFamily: "'Nunito', sans-serif", google: true },
    { label: 'Ubuntu', value: 'Ubuntu', fontFamily: "'Ubuntu', sans-serif", google: true },
    { label: 'Ranade', value: 'Ranade', fontFamily: "'Ranade', sans-serif", google: true },
    { label: 'Source Sans Pro', value: 'Source Sans Pro', fontFamily: "'Source Sans Pro', sans-serif", google: true },
    { label: 'Work Sans', value: 'Work Sans', fontFamily: "'Work Sans', sans-serif", google: true },
    { label: 'Manrope', value: 'Manrope', fontFamily: "'Manrope', sans-serif", google: true },
    { label: 'Object Sans', value: 'Object Sans', fontFamily: "'Object Sans', sans-serif", google: true },
    { label: 'Raleway', value: 'Raleway', fontFamily: "'Raleway', sans-serif", google: true },
    { label: 'Montserrat', value: 'Montserrat', fontFamily: "'Montserrat', sans-serif", google: true },
    { label: 'Playfair Display', value: 'Playfair Display', fontFamily: "'Playfair Display', serif", google: true },
    { label: 'Libre Baskerville', value: 'Libre Baskerville', fontFamily: "'Libre Baskerville', serif", google: true },
    { label: 'Soria', value: 'Soria', fontFamily: "'Soria', serif", google: true },
    { label: 'Neuton', value: 'Neuton', fontFamily: "'Neuton', serif", google: true },
    { label: 'Lora', value: 'Lora', fontFamily: "'Lora', serif", google: true },
    { label: 'Sreda', value: 'Sreda', fontFamily: "'Sreda', serif", google: true },
    { label: 'Arvo', value: 'Arvo', fontFamily: "'Arvo', serif", google: true },
];
